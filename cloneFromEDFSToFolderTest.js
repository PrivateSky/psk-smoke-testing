...
$$.flows.describe("BarClone", {
    ...
    createArchive: function () {
        ...
        this.folderBrickStorage = bar.createFolderBrickStorage(savePath);
        this.addFolder();
    },
    ...
    extractFolder: function () {
        this.archiveConfigurator.setStorageProvider("FolderBrickStorage", savePath);
...
double_check.createTestFolder("bar_test_folder", (err, testFolder) => {
    ...
    folders = [folderPath, savePath, cloneStoragePath];
